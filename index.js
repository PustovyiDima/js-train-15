...
function generateRandomPassword(length) {
   ...
   for (let i = 0; i < length; i++) {
      ...
      char = characters[Math.ceil(random)];
      password += char;
   }
   return password;
}
...
function calculateCircleArea(radius) {
   ...
   if (typeof radius === "number") {
      ...
      console.log("Помилка: заданий радіус повинен бути числом");
      return null;
   }
}
...
function findMinMax(numbers) {
   ...
   return Array.isArray(numbers)
      ...
      : (console.log("Error input element type must be Array"), null);
}
...
function calculateHypotenuse(a, b) {
   ...
   return typeof a === "number" && typeof b === "number"
      ? `Довжина гіпотенузи для прямокутного трикутника з катетами довжиною ${a} та ${b}, дорівнює ${Math.sqrt(
           Math.pow(a, 2) + Math.pow(b, 2)
        )}`
      : (console.log("Error input elements type must be numbers"), null);
}
...
function estimateInvestment(principal, interestRate, years) {
   ...
   if (
      ...
      let invest = principal * Math.pow(++interestRate, years);
...
function isTotalPriceExceedsMaxPrice(products, maxPrice) {
   ...
   if (Array.isArray(products) && typeof maxPrice === "number") {
      ...
      console.log(
         "Перший аргумент повинен бути масивом а максимальна ціна числом"
      );
      return null;
   }
}
